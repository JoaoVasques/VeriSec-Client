...
public class AIACClientAboutBox extends javax.swing.JDialog {

    public AIACClientAboutBox(java.awt.Frame parent) {
        super(parent);
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(aiacclient.AIACClientApp.class).getContext().getResourceMap(AIACClientAboutBox.class);
        setTitle(resourceMap.getString("title")); // NOI18N
        setModal(true);
        setName("aboutBox"); // NOI18N
        setResizable(false);

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(aiacclient.AIACClientApp.class).getContext().getActionMap(AIACClientAboutBox.class, this);
